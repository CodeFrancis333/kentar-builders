...
function HeroSection() {
  return (
    <section id="home" className="relative overflow-hidden bg-brandBlue text-white">
      <div className="absolute inset-x-0 top-0 h-16 bg-[linear-gradient(180deg,rgba(255,255,255,1)_0%,rgba(255,255,255,0.8)_38%,rgba(255,255,255,0.08)_72%,rgba(255,255,255,0)_100%)]" />
